...
//removes the warning about parsing frame errors as it often overreacts
//until flixel adds supressing warnings or flixel 5.9.0 changes this this is needed
